...
#define BT_SCO_MAV_EN                   0   //是否打开蓝牙通话变声功能,默认关掉声加单双麦降噪算法
...
#define BT_SNDP_EN                      1                           //是否打开声加降噪算法
#define BT_SNDP_TYPE                    0 							//声加单mic算法类型: 0(RNN), 1(DNN)
#define BT_SNDP_MODE                    0                           //单麦模式模式0，模式1
//#define BT_SNDP_DMIC_EN                 0
#define BT_SNDP_DUMP_EN                 0                           //是否打开声加算法数据打印

#define BT_SCO_FAR_NR_EN                0   //是否打开远端降噪算法
#define BT_SCO_FAR_NOISE_LEVEL          12  //强度（0~30dB，越大降噪效果越好，音质越差）
#define BT_SCO_FAR_NOISE_THRESHOID      100 //远端环境噪声阈值（低于此阈值便认为是噪声）(0~65535)

#define BT_NEAR_AINS2_EN                0   //是否打开声加单麦前的AINS2, 可以对喇叭声降噪
#define BT_NEAR_AINS2_NOISE_LEVEL       5   //ains2(0~30,默认20)

#define BT_TRUMPET_DENOISE_EN           0   //是否打开喇叭声降噪
#define BT_SCO_FADE_EN                  0   //使能通话前500ms淡入，默认mute掉

//BLE功能配置
#define LE_BQB_RF_EN                    0   //BLE DUT测试模式，使用串口通信
#define LE_PAIR_EN                      1   //是否使能BLE的加密配对
#define LE_ADV_POWERON_EN               1
#define LE_DUEROS_EN                    0   //是否打开DUEROS功能
#define LE_APP_EN                       0   //是否打开AB-LINK APP控制功能
...
#define IIS_REC_EN                      0   //是否打开IIS录音功能
...
#define I2C_MAPPING                     I2CMAP_PF4PF5 //选择I2C mapping
