...
#define TWS_FEAT_PRIORITY_ROLE          0x1000  //TWS配对连接时可配置优先为主机
...
extern uint8_t cfg_bt_pair_only_odev;
...
uint8_t bt_a2dp_get_codec_type(void); //获取当前a2dp codec类型 0=sbc 1=aac 0xff=unkown
