 ...
 *****************************************************************************/
#ifndef SDK_VERSION
    #define SDK_VERSION             0x0110      //V011.0
#endif
...
#if LE_APP_EN || LE_BQB_RF_EN || GFPS_EN
    #define LE_EN                   1
...
#ifndef BT_SCO_MAV_EN
#define BT_SCO_MAV_EN               0
#endif

#if BT_SCO_MAV_EN
#undef BT_SNDP_EN
#define BT_SNDP_EN                  0
#undef BT_SNDP_DMIC_EN
...
#if BT_NLMS_AEC_EN && (BT_SNDP_MODE || BT_SCO_AINS2_MODE || BT_SCO_DNN_MODE)
#error "NLMS_AEC_DBG: please set BT_SNDP_MODE and BT_SCO_AINS2_EN to 0\n"
#endif

#if (BT_SNDP_DMIC_EN || BT_SCO_DMNS_EN) && (BT_SNDP_EN || BT_SCO_AINS2_EN || BT_SCO_DNN_EN)
#error "NR_DBG: please select only one nr algorithm in BT_SNDP_DMIC_EN or BT_SNDP_EN or BT_SCO_AINS2_EN\n"
#endif

#if BT_SNDP_EN && BT_SCO_AINS2_EN && BT_SCO_DNN_EN
#error "NR_DBG: please select only one nr algorithm in BT_SNDP_DMIC_EN or BT_SNDP_EN or BT_SCO_AINS2_EN\n"
#endif
